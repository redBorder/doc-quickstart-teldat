...
Espere hasta que la instalación se haya completado al 100%.
...
. *Network Configuration*: creación de bondings, segmentos, DNS, rutas e IPMI.
...
. *Passwords*: acceda a esta opción si desea modificar las contraseñas de los usuarios del sistema.
...
Si existe algún servidor NTP en su red que quiera utilizar, se debe indicar aquí. En caso contrario, se asignará uno por defecto.
