...
muestra sobre el listado de usuarios dados de alta.

image::images/users/users-02.png["users-02",link="images/users/users-02.png",align="center"]

Sólo el usuario con el rol de *Súper Administrador* tiene habilitada esta función. El resto de usuarios sólo podrá visualizar las
